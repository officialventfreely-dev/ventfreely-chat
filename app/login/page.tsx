...
/**
 * GlowCard – sama “ere lilla outline + glow outside” vibe nagu Chat/Daily/Weekly.
 */
...
export default function LoginPage() {
  ...
  const title = useMemo(() => {
    if (nextPath.startsWith("/daily")) return "Log in to continue Daily";
    if (nextPath.startsWith("/weekly")) return "Log in to continue Weekly";
    if (nextPath.startsWith("/insights")) return "Log in to view Insights";
    if (nextPath.startsWith("/account")) return "Log in to view Account";
    return "Log in to Ventfreely";
  }, [nextPath]);
